...
import tmpl from './otbaLWCSensoryLightTouch.html';
import { OmniscriptBaseMixin } from 'omnistudio/omniscriptBaseMixin';

export default class OtbaLWCSensoryLightTouch extends OmniscriptBaseMixin(OmniscriptSelect) {
    circles = [                
    ...
    fetchJsonBeforeSelectBodyPart(selectedOption) {                
        if (this.jsonData && this.jsonData.PhysicalAssessment && this.jsonData.PhysicalAssessment.HC_CHA_OTBA_SensoryObservationLighttouchsensation) {
            const BodyPartAssessmentData = this.jsonData.PhysicalAssessment.HC_CHA_OTBA_SensoryObservationLighttouchsensation;
            ...
            const isExist = assessmentDataArray.some(selection =>
                selection.HC_CHA_OTBA_LocationofLighttouchsensation === selectedOption
            );
