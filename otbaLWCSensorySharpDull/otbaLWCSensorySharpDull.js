...
import tmpl from './otbaLWCSensorySharpDull.html';
import { OmniscriptBaseMixin } from 'omnistudio/omniscriptBaseMixin';

export default class OtbaLWCSensorySharpDull extends OmniscriptBaseMixin(OmniscriptSelect) {
    circles = [                
    ...
    fetchJsonBeforeSelectBodyPart(selectedOption) {                
        if (this.jsonData && this.jsonData.PhysicalAssessment && this.jsonData.PhysicalAssessment.HC_CHA_OTBA_SensoryObservation) {
            const BodyPartAssessmentData = this.jsonData.PhysicalAssessment.HC_CHA_OTBA_SensoryObservation;
            ...
            const isExist = assessmentDataArray.some(selection =>
                selection.HC_CHA_OTBA_LocationofSharpDul_discrimination === selectedOption
            );
